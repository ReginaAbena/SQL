...
-- Table 1: All products in database listed in Product_Masterlist table
...
-- Table 2: Products that can be bought in Superdrug listed here
...
-- Table 3: Products that can be bought in Boots listed here
create table Boots(
Product_Name VARCHAR(75),
Product_Price DECIMAL(4,2),
Product_Hair_Texture VARCHAR(10),
...
-- Table 4: Products that can be bought on Asos listed here
create table Asos(
Product_Name VARCHAR(75),
Product_Price DECIMAL(4,2),
Product_Hair_Texture VARCHAR(10),
...
-- Table 5: Ethical questions about products found in this table
create table Ethics(
Product_Name VARCHAR(75),
Product_Brand VARCHAR(50),
...
-- Table 6: Chemicals found in products shown in this table
...
-- Table 7: Product Ratings (out of 5 stars) found in this table
create table Rating(
Product_Name VARCHAR(75),
Rating INTEGER
);
